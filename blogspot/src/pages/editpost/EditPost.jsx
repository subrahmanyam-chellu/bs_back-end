...
const EditPost = () => {
    ...
    const handleSumbit = async (e) => {
        try {
            const result = await axios.patch(`${import.meta.env.VITE_BACKEND_URL}/updatepost/${id}`, { post: { _id: id, title, image: imageUrl, content, penName, authorId, status } },
